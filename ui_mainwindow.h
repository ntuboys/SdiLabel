...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionSave_Annotations->setObjectName(QStringLiteral("actionSave_Annotations"));
        actionSave_Class_File = new QAction(MainWindow);
        actionSave_Class_File->setObjectName(QStringLiteral("actionSave_Class_File"));
        actionOpen_Annotations = new QAction(MainWindow);
        actionOpen_Annotations->setObjectName(QStringLiteral("actionOpen_Annotations"));
        actionOpen_Class_File = new QAction(MainWindow);
        actionOpen_Class_File->setObjectName(QStringLiteral("actionOpen_Class_File"));
        actionOpen_Images_Folder = new QAction(MainWindow);
        actionOpen_Images_Folder->setObjectName(QStringLiteral("actionOpen_Images_Folder"));
        ...
        sizePolicy1.setHeightForWidth(newClassText->sizePolicy().hasHeightForWidth());
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionSave_Annotations->setText(QApplication::translate("MainWindow", "Save Annotations", Q_NULLPTR));
        actionSave_Class_File->setText(QApplication::translate("MainWindow", "Save Class File", Q_NULLPTR));
        actionOpen_Annotations->setText(QApplication::translate("MainWindow", "Open Annotations", Q_NULLPTR));
        actionOpen_Class_File->setText(QApplication::translate("MainWindow", "Open Class File", Q_NULLPTR));
        actionOpen_Images_Folder->setText(QApplication::translate("MainWindow", "Open Images Folder", Q_NULLPTR));
        ...
        ellip->setText(QApplication::translate("MainWindow", "Ellipsis", Q_NULLPTR));
        ...
        addClass->setText(QApplication::translate("MainWindow", "Add Class", Q_NULLPTR));
        newClassText->setText(QApplication::translate("MainWindow", "test", Q_NULLPTR));
        removeClass->setText(QApplication::translate("MainWindow", "PushButton", Q_NULLPTR));
